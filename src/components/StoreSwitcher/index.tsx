...
export default function StoreSwitcher({ stores }: StoreSwitcherProps) {
  ...
  return (
    <>
      <div onClick={() => setVisible(true)} style={switcherStyle}>
        <MapPin size={13} /> 切换门店
      </div>

      <Popup visible={visible} onMaskClick={() => setVisible(false)} bodyStyle={{ borderTopLeftRadius: 20, borderTopRightRadius: 20, padding: 16 }}>
